...
namespace Vote.Web.Migrations
{
    ...
    [Migration("20190419145255_CountriesAndCities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vote.Web.Data.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Vote.Web.Data.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Vote.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Vote.Web.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Vote.Web.Data.Entities.City", b =>
                {
                    b.HasOne("Vote.Web.Data.Entities.Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Vote.Web.Data.Entities.Vote", b =>
                {
                    ...
                    b.HasOne("Vote.Web.Data.Entities.Event", "Event")
                        .WithMany()
